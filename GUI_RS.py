...
def take_img():
    try:
        ...
        Enrollment = txt.get()
        Name = txt2.get()
        path = 'Datasets/' + Enrollment + ' ' + Name
        new_path = 'Datasets/' + Enrollment + ' ' + Name + '/'
        os.mkdir(path)
        sampleNum = 0
...
message = tk.Label(window, text="Attendance System using Cascade Classifier", bg="SpringGreen3", fg="white", width=50,
...
txt2 = tk.Entry(window, width=20, bg="red", fg="red", font=('times', 25, ' bold '))
txt2.place(x=550, y=310)


clearButton = tk.Button(window, text="Clear",command=clear,fg="white"  ,bg="#ff8080"  ,width=10  ,height=1 ,activebackground = "Red" ,font=('times', 15, ' bold '))
...
takeImg = tk.Button(window, text="Take Images",command=take_img,fg="white"  ,bg="#ff8080"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
