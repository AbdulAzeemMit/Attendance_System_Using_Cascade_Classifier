...
window = tk.Tk()
window.title("Attendance System using Cascade Classifier")
...
#             print(ex)  #
        ...
        if subb=='':
            ...
            ENR = tk.Label(MFW, text="Enter Enrollment", width=15, height=2, fg="white", bg="#ff8080",
                           font=('times', 15, ' bold '))
                    ...
                    for col in reader:
                        ...
                        for row in col:
                            ...
                            label = tkinter.Label(root, width=13, height=1, fg="black", font=('times', 13, ' bold '),
                                                  bg="#ff8080", text=row, relief=tkinter.RIDGE)
...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            if(os.path.isfile("StudentDetails\StudentDetails.csv")==True):
...
#                             print(aa)
                            ...
                            cv2.putText(im, str(tt), (x , y-15), font, 1, (150,255,0), 2)
                        else:
                            Id = 'Unknown'
                            tt = str(Id)
...
#         win.configure(background='snow')
        ...
        username = 'abdul'#un_entr.get()
        password = 'mit'#pw_entr.get()
                ...
                with open(cs, newline="") as file:
                    ...
                    for col in reader:
                        ...
                        for row in col:
                            # i've added some styling
                            label = tkinter.Label(root, width=8, height=1, fg="black", font=('times', 15, ' bold '),
                                                  bg="#b3d9ff", text=row, relief=tkinter.RIDGE)
                            label.grid(row=r, column=c)
                            c += 1
                        r += 1
                root.mainloop()
...
message = tk.Label(window, text="Attendace System using Cascade Classifier", bg="light sky blue", fg="black", width=70,
...
txt = tk.Entry(window, validate="key", width=20, fg="black", font=('times', 25, ' bold '))
...
takeImg = tk.Button(window, text="Take Images",command=take_img,fg="white"    ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
...
FA = tk.Button(window, text="Automatic Attendace",fg="white",command=subjectchoose    ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
FA.place(x=690, y=500)
FA['bg']='#4d88ff'


quitWindow = tk.Button(window, text="Registered Students", command=log_in  ,fg="black"    ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
quitWindow.place(x=990, y=500)
quitWindow['bg']='#00e673'
